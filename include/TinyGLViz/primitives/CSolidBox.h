...
namespace TinyGLViz {
    ...
    class CSolidBox : public CGLPrimitive
    {
    public:
    ...
    public:
        CSolidBox(T_real d_x = 1.0, T_real d_y = 1.0, T_real d_z = 1.0,
                  const CTransform<T_real> &t = CTransform<T_real>()) {
            m_dim[0] = d_x;
            m_dim[1] = d_y;
            m_dim[2] = d_z;
            generateVertexData();
        ...
        void setDimensions(T_real x, T_real y, T_real z) {
            m_dim[0] = x;
            m_dim[1] = y;
            m_dim[2] = z;
        }
