...
namespace TinyGLViz {
    ...
    class CSolidCylinder: public CGLPrimitive {
    public:
    ...
    public:
        CSolidCylinder(T_real radius = 1.0, T_real height = 1.0, const CTransform <T_real> &t = CTransform<T_real>(),
                       T_int resolution = 20) {
            m_radius = radius;
            m_height = height;
        ...
        void setResolution(T_int resolution) {
            m_resolution = resolution;
            generateVertexData();
        }
        ...
        T_int getResolution() { return m_resolution; }
